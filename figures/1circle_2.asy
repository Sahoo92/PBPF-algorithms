...
draw((position_circle[0].x,position_circle[0].y+radius)::(2.5,0)::(position_circle[0].x,position_circle[0].y-radius), black+linewidth(width_line), bar=Bar(arrow_size));
//draw((position_circle[1].x,position_circle[1].y-radius)::(3,-height_of_turn)::(position_circle[0].x,position_circle[0].y-radius), black+linewidth(width_line), arrow=ArcArrow(SimpleHead,arrow_size));
