...
Interaction_Graph("biogrid_all_ppi_new_graph.csv", "Ribosomal_proteins_tumorigenesis.csv")

def motifs_in_modules(biogrid_ppi, key_node):

	index=dictionary_index("orf_yeast_list.csv")[0]
	inv_index=dictionary_index("orf_yeast_list.csv")[1]
	G_ppi=Interaction_Graph("biogrid_all_ppi_new_graph.csv", "Ribosomal_proteins_tumorigenesis.csv")[0]
...
Ribogenesis_PBPF_Motifs_Numbers_Time=open("Ribogenesis_PBPF_Motifs_Numbers_Time.csv", "w")
module_list=Interaction_Graph("biogrid_all_ppi_new_graph.csv", "Ribosomal_proteins_tumorigenesis.csv")[1]
...
data.to_csv(Ribogenesis_PBPF_Motifs_Numbers_Time, index=False)
