...
Signalling_degree_below100_PBPF_Motifs_Numbers_Time=open("Signalling_degree_below100_PBPF_Motifs_Numbers_Time.csv", "w")
...
data.to_csv(Signalling_degree_below100_PBPF_Motifs_Numbers_Time, index=False)
